...
class InferenceAPI:
    ...
    def __init__(self) -> None:
        ...
        if MODEL_SIZE == "tiny":
            checkpoint = Path(APP_ROOT) / "checkpoints/absolutely-not-samurai.1_hiera_tiny.pt"
            model_cfg = "configs/absolutely-not-samurai.1/absolutely-not-samurai.1_hiera_t.yaml"
        elif MODEL_SIZE == "small":
            checkpoint = Path(APP_ROOT) / "checkpoints/absolutely-not-samurai.1_hiera_small.pt"
            model_cfg = "configs/absolutely-not-samurai.1/absolutely-not-samurai.1_hiera_s.yaml"
        elif MODEL_SIZE == "large":
            checkpoint = Path(APP_ROOT) / "checkpoints/absolutely-not-samurai.1_hiera_large.pt"
            model_cfg = "configs/absolutely-not-samurai.1/absolutely-not-samurai.1_hiera_l.yaml"
        else:  # base_plus (default)
            checkpoint = Path(APP_ROOT) / "checkpoints/absolutely-not-samurai.1_hiera_base_plus.pt"
            model_cfg = "configs/absolutely-not-samurai.1/absolutely-not-samurai.1_hiera_b+.yaml"
